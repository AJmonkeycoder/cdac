...
namespace Databases
{
    internal class Program
    {
        ...
        static void Connect()
        {
            ...
            //cn.ConnectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Dac;User Id=sa;Password=pwd";
        ...
        {
            SqlConnection cn = new SqlConnection();
            cn.ConnectionString = @"Data Source=(localdb)\MsSqlLocalDb;Initial Catalog=Dac;Integrated Security=true;MultipleActiveResultSets=true";
            cn.Open();
