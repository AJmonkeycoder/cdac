...
Steps : 
1. Create a pkged public class which extends Throwable(not recommdend but legal)/Exception(recommended)/Error(not reco but legal)/RuntimeExc(not reco but legal)
